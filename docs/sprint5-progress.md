...
|----|------|------|---------|--------|
| S5-01 | exam_publish 发布配置接口（监考/人脸核验/乱序配置）+ ExamMonitor/ExamSubmitQueue 实体 + 学生端列表 API + XXL-Job状态同步 | ✅ 完成 | 2026-06-18 | TBD |
| S5-02 | POST /exam/{id}/enter 进入考试（密码验证/人脸核验/分批下题） | 🔲 待开始 | - | - |
| S5-03 | 【C2核心】交卷容灾（Redis幂等+Kafka+XXL-Job落库） | 🔲 待开始 | - | - |
